...
const DEFAULTS: Record<StoreKey, unknown[]> = {
  ...
  loads: [
    ...
    { id: "l7", referenceNumber: "LD-2026-0153", customer: "Apex Auto Group", customerPhone: "(404) 555-8900", pickupLocation: "Savannah, GA", deliveryLocation: "Tampa, FL", pickupDate: "2026-03-14", deliveryDate: "2026-03-15", vehicleInfo: "2023 Jeep Wrangler", status: "delivered", driverId: "d7", price: 950, notes: "", carIds: ["car3"] },
    { id: "l8", referenceNumber: "LD-2026-0154", customer: "SBT", customerPhone: "", pickupLocation: "SBT", deliveryLocation: "FAMILY", pickupDate: "2026-03-30", deliveryDate: "", vehicleInfo: "VINs pending", status: "booked", driverId: "d1", price: 0, notes: "[VINs needed]" },
  ] as Load[],
  expenses: [
